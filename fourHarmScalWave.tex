...
\begin{document}
  \begin{opening}
    ...
    \author{Anders\surname{Andersson}\email{anders.andersson@jth.hj.se}}
    \institute{School of Engineering, J\"onk\"oping University, 
      J\"onk\"oping}
    \author{B\"orje\surname{Nilsson}\email{borje.nilsson@lnu.se}}
    \institute{Linn\ae us Univerity, V\"axj\"o}
    \author{Thomas\surname{Biro}\email{thomas.biro@jth.hj.se}}
    \institute{School of Engineering, J\"onk\"oping University, 
      J\"onk\"oping}
    \begin{abstract}
