...
\begin{opening}
  ...
  \institute{School of Engineering, J\"onk\"oping University,
    ...
    \surname{Nilsson}\email{borje.nilsson@lnu.se}} \institute{Linn\ae
    us University, V\"axj\"o} \author{Thomas
    \surname{Biro}\email{thomas.biro@jth.hj.se}} \institute{School of
    Engineering, J\"onk\"oping University, J\"onk\"oping}
  \runningtitle{Fourier Methods for Harmonic Scalar Waves in General Waveguides}
  \runningauthor{Andersson, Nilsson, Biro}
  \begin{abstract}
    Wave scattering problems in two-dimensional waveguides of general
    shapes and with varying boundary conditions are solved, using a
    mixture of old and new techniques, including Fourier series,
    conformal mappings, ....
  \end{abstract}
...
\cite{Brauer:1964},\cite{Brauer:1965} but Paley-Wiener space techniques
