...
$\Omega_3$. Furthermore, we use the following denotation:
\begin{center}
  \begin{tabular}{ll}
    Symbol&Explanation\\
    \hline
...
Assume that a right-marching field $\Phiin=\Phi^+(t_0)$ is entering 
...
$\Omega_1$ and $\Omega_2$, $\Phi^+(0)=C^+(0)\Phiin$ and
$\Phi^-(0)=C^-(0)\Phiin$. Standard theory for
